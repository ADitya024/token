...
let source = fs.readFileSync("./goku_contract_abi.json");
let contracts = JSON.parse(source)["SimpleStorage"];

// ABI description as JSON structure
let abi = JSON.parse(contracts.SimpleStorage.abi);

// Smart contract EVM bytecode as hex
let code = '0x' + contracts.SimpleStorage.bin;
